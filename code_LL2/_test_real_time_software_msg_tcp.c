/////////////////////////////////////////////////////////////////////////////
//
//  _test_real_time_software_msg_tcp.c
//
...
void
test_real_time_software_msg_tcp(ADC_HandleTypeDef* hadc1, ADC_HandleTypeDef* hadc3) {
			...
			if (lowerlimb_sys_info.system_state == SYS_ON) {
				...
				///////////////////////////////////////////////////////////////////////////////
					...
					///////////////////////////////////////////////////////////////////////////////
						...
						#if USE_ITM_OUT_RT_CHECK
							printf("   <test_real_time_software_msg_tcp()> Invalid exercise substate [%s] for activity_state == EXERCISE] \n\n", EXERC_STATE_STR[lowerlimb_sys_info.exercise_state]);
						#endif
					}
