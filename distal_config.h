/** ========================================
 ...
 ========================================
 Hman config header file.

 ======================================== */

#ifndef  DISTAL_CONFIG_H_
#define DISTAL_CONFIG_H_
...
#define DISTAL_MAX_BXX          	300                     	// in Ns/m Max value of BXX for which Distal is stable
#define DISTAL_MAX_BYY          	300                    		// in Ns/m Max value of BYY for which Distal is stable
#define DISTAL_MIN_BXX          	(-1 * DISTAL_MAX_BXX)     	// in Ns/m MIN value of BXX for which Distal is stable
#define DISTAL_MIN_BYY          	(-1 * DISTAL_MAX_BYY)     	// in Ns/m MIN value of BYY for which Distal is stable

// Distal device safety limits
#define DISTAL_SAMPLING_MAX		1.1							//in ms
#define DISTAL_RT_MAX_VEL		1.5							//in m/s. Defines the max real-time x y velocities.
